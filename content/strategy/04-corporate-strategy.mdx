...
<Diagram>
quadrantChart
    title Ansoff Matrix: Real Corporate Moves
    ...
    Coca-Cola advertising push: [0.18, 0.15]
    McDonald's menu expansion: [0.25, 0.28]
    Starbucks enters China: [0.82, 0.16]
    Netflix international: [0.76, 0.22]
    Apple Watch: [0.22, 0.78]
    Amazon Prime Video: [0.3, 0.72]
    Amazon AWS: [0.82, 0.84]
    Disney Plus: [0.74, 0.78]
</Diagram>
...
<Slide title="Corporate Strategy">

Two distinct strategic questions — often confused:

- **Business unit strategy** — how does the iPhone compete against Samsung in smartphones?
- **Corporate strategy** — should Apple be in smartphones, computers, wearables, and streaming simultaneously, and how do those relate?

Corporate strategy answers three questions:

1. What businesses should we be in?
2. How do those businesses relate to each other?
3. How do we allocate capital and management attention across them?

*This is where large companies — and large amounts of shareholder value — most often go wrong.*

</Slide>

<Slide title="When Does Diversification Create Value?">

The critical test: **does it create value that shareholders couldn't create themselves?**

If investors can buy shares in Company A and Company B separately, why pay a premium for a conglomerate that owns both?

Value must come from:
- **Operating synergies** — shared capabilities, distribution, or brand
- **Internal capital markets** — allocating capital better than external markets would
- **Transferable capabilities** — the same skills that win in one market apply to another

*Purely financial diversification — owning unrelated businesses to reduce earnings volatility — rarely creates shareholder value.*

</Slide>

<Slide title="Four Paths to Growth: Ansoff Matrix">

<Matrix2x2
  xAxis={{ label: "Markets", low: "Existing", high: "New" }}
  yAxis={{ label: "Products", low: "Existing", high: "New" }}
  quadrants={[
    { label: "Market Penetration", position: "bottom-left", description: "Sell more to existing customers. Lowest risk, often highest return." },
    { label: "Market Development", position: "bottom-right", description: "Take existing products to new markets. Geographic expansion, new segments." },
    { label: "Product Development", position: "top-left", description: "New products for existing customers. Leverages existing relationships." },
    { label: "Diversification", position: "top-right", description: "New products in new markets. Highest risk — needs transferable capabilities." }
  ]}
/>

</Slide>

<Slide title="Vertical Integration: Make or Buy?">

**Forward integration** — toward the customer (Apple opening retail stores; Disney launching Disney+)

**Backward integration** — toward inputs (Tesla manufacturing its own batteries; Apple designing its own chips)

Integration makes sense when:
- The activity is strategically critical and you need proprietary control
- You have superior capabilities in the activity
- The activity is a key source of differentiation

**Apple's chip design cost billions and required thousands of semiconductor engineers — but created performance advantages competitors haven't neutralised.**

</Slide>

<Slide title="Portfolio Strategy: BCG Matrix">

Four quadrants based on market growth and relative market share:

- **Stars** — high growth, high share: invest heavily to maintain position
- **Cash Cows** — low growth, high share: generate cash to fund Stars
- **Question Marks** — high growth, low share: invest to become Stars, or exit
- **Dogs** — low growth, low share: divest unless serving a strategic purpose

*The insight remains valuable: different business units require different management approaches. The risk: "harvest cash cows" logic can become self-fulfilling through underinvestment.*

</Slide>

<Slide title="The Parenting Advantage Test">

> **A corporation creates value only when it improves business unit performance more than an alternative owner would.**

Ask: why is this business better owned by us than by:
- Its managers as a standalone company?
- A private equity firm?
- A competitor operating in an adjacent space?

**The firms that consistently create corporate value have a clear theory of their parenting advantage:**
- Berkshire Hathaway — identifies moats, leaves management alone
- Danaher — applies its operating system to every acquisition
- Constellation Software — playbook-based management of vertical software businesses
