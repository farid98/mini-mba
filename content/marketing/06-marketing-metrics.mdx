...
<Discussion>
1. A social app has DAU/MAU stickiness of 8% against a category benchmark of 50–70%. What are the most likely explanations, and would you prioritise fixing retention or accelerating acquisition first?
2. Your LTV:CAC ratio is 6:1 and the team is celebrating. Why might a ratio this high actually be a warning sign rather than a cause for celebration?
3. A SaaS company shows strong MRR growth and rising ARPU, but NRR of 88%. What does this combination tell you, and what would you investigate first?
4. CAC is rising quarter-on-quarter. Walk through three distinct hypotheses — one involving channel saturation, one involving product-market fit, and one involving competitive dynamics.
5. You must choose between SEO (3-month payback, 12-month ramp to scale) and paid social (immediate volume, 18-month payback). How do your current cash position and growth targets affect the decision?
</Discussion>
