...
<Slide title="The Operating System You Can't See" variant="title">

Every organizational failure gets blamed on culture eventually. The merger that didn't deliver. The strategy that couldn't get traction. The talent that kept leaving.

> Culture is the operating system running underneath the strategy, the structure, and the processes. When it's misaligned, nothing else works as designed.

The difficulty is that culture is invisible—especially to insiders. You can't see it in a spreadsheet, measure it in a quarterly report, or fix it in a reorganization. It shapes every interaction and every decision, and it does so below conscious awareness.

Edgar Schein spent decades studying how culture actually works. His three-level model is the most useful tool for making the invisible visible.

</Slide>

<Slide title="Schein's Three Levels of Culture">

- **Level 1: Artifacts** — the visible surface: office layouts, meeting rituals, dress codes, who gets recognized and how. Easy to observe, misleading without context.

- **Level 2: Espoused values** — what the organization claims to believe: "we put customers first," "we value candor," "integrity is non-negotiable." These may or may not match actual behavior. The gap between what is espoused and what is enacted is where organizational hypocrisy lives—and employees notice it immediately and permanently.

- **Level 3: Underlying assumptions** — the unconscious, taken-for-granted beliefs that actually drive behavior: "we believe assertive people deserve to be heard regardless of hierarchy," "we believe failure means incompetence." These are rarely stated because they're assumed. They're also the hardest to change.

Understanding culture requires getting to Level 3. Surveys and focus groups reveal Levels 1 and 2. Prolonged behavioral observation reveals Level 3.

</Slide>

<Slide title="How Culture Forms (And Why Values Posters Don't Work)">

Cultures form through the accumulated weight of what leaders *do*, not what they say:

- **Founder imprinting** — Founders make early hiring decisions, model behavior, and establish precedents. Amazon's leadership principles are Bezos's principles. Apple's design obsession was Jobs's obsession. Founder cultures are coherent and strong—and hard to change when the founder is wrong.
- **Critical incident response** — How leadership responds to crises reveals what it actually values. Firing your highest-revenue salesperson for an ethics violation signals that integrity is real. Protecting them signals the opposite—and that signal spreads quietly but indelibly.
- **Selection and retention** — Organizations become culturally homogeneous over time as they hire people who fit and lose people who don't. The Attraction-Selection-Attrition cycle can produce deep alignment or deep collective blindness.

Culture is not declared. It is demonstrated, in the moments that matter.

</Slide>

<Slide title="Netflix's Honest Culture Document">

Reed Hastings published Netflix's internal culture document in 2009. It spread virally because it was honest in a way most corporate values statements aren't.

It acknowledged that Netflix was not a family but a "professional sports team." That performance above a certain threshold was the minimum expectation. That managers should regularly ask themselves whether they would fight to keep each direct report—and act accordingly if the answer was no.

The directness was itself cultural: it modeled the candid communication the company valued.

But the deeper lesson is not about what the document said—it's about *why it worked*. The document described what was actually true. Most culture documents describe what leadership wishes were true. Netflix's worked because its behavior actually reflected it. The culture document was a description, not an aspiration.

</Slide>

<Slide title="Strong Culture Is a Double-Edged Asset" variant="highlight">

Strong cultures—where norms are widely shared and deeply held—reduce coordination costs, enable faster decisions, and generate genuine employee commitment. They are associated with better performance in stable environments.

In changing environments, they become liabilities.

IBM's culture of hardware excellence and long-term customer relationships was enormously valuable during the mainframe era. It became an obstacle when the industry shifted to software and services. Blockbuster's physical retail culture became irrelevant when streaming made the physical store unnecessary.

**The same cultural DNA that makes you excellent in one era will resist the changes required to succeed in the next.** The early warning signal: when your strongest cultural advocates become the loudest voices against the most important changes. That's not loyalty—that's the immune system activating.

</Slide>

<Slide title="Key Takeaways">

- **Culture operates at three levels** — artifacts, espoused values, and underlying assumptions; you need to reach Level 3 to understand what's actually driving behavior
- **Culture forms through behavior, not declarations** — founder imprinting, how leaders respond to critical incidents, and who gets hired and retained are the actual mechanisms
- **Strong culture is context-dependent** — an asset in stable environments, a liability when the environment changes; IBM and Blockbuster are the cautionary cases
- **Diagnosing culture requires behavioral observation** — watch what people do when no one is watching, not what they say in surveys
- **Changing culture takes 5–10 years minimum** — consistent modeling, changed narratives, changed selection criteria, and new rituals; none of it works without genuine behavioral change at the leadership level
